		...
		<table width="800px" height="600px" border="1px" align="center">
			<tr height="100px">
				<td>
					...
					<a href="<?php echo site_url('Welcome/DataProfile'); ?>">Data Profile</a>
					<a href="<?php echo site_url('Welcome/DataKontak'); ?>">Data Kontak</a>
					<a href="<?php echo site_url('Welcome/DataKontak'); ?>">Data Berita</a>
